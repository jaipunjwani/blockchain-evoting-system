...
class TestBallotClass(unittest.TestCase):
    ...
    def test_retrieve(self):
        self.test_ballot_obj.state = 'ballot_issued'
        self.assertEqual(self.test_ballot_obj.state, 'ballot_issued')
...
class TestBallotItemClass(unittest.TestCase):
    def setUp(self):
        ...
        self.test_ballotItem = BallotItem(title, description, max_choices, choices)
    ...
    def test_deep_copy(self):
        copied_item = deepcopy(self.test_ballotItem)
...
class TestVoteLedgerClass(unittest.TestCase):
    ...
    def test_add_transactions(self):
        ...
        self.vote_ledger.add_transactions(txs)
